...
import { Divider, Drawer, List, Popconfirm, Row, Table, Form, Upload, Button } from 'antd';
...
function TugasTopic({ idtopic }) {
    ...
    const simpanTugas = (val) => {
        ...
        var fileNe = document.querySelector(`#filetugas`);
            ...
            <_Row>
                ...
                <_Col sm={4}>
                    <div style={{ marginBottom: "-10px", marginLeft: "10px" }}>
                        ...
                        >
                            <_Input label="Durasi" sm={5} addonAfter="Menit" name="durasi" />
