            ...
            options: {
                lessLoaderOptions: {
                    lessOptions: {
                        ...
                        modifyVars: {
                            '@primary-color': '#ef5c17', // primary color for all components
                            ...
                            '@border-color-base': '#f8a477', // major border color
                            '@box-shadow-base': '0 3px 6px -4px #ea531670, 0 6px 16px 0 #ea531670,0 9px 28px 8px #ea531670', // major shadow for layers
                            ...
                            '@table-header-sort-bg': '#ec580f',
                            '@table-body-sort-bg': '#ec580f',
                            ...
                            '@input-hover-border-color': '#ef5c17',
